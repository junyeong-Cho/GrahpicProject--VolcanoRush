...
int main(int argc, char *argv[]) {
  ...
  /*
  #ifdef _WIN32 // If the code is being compiled for Windows
    Sleep(sleepFor); // Windows-specific sleep in milliseconds
  #else
    std::this_thread::sleep_for(std::chrono::milliseconds(sleepFor)); // std::this_thread sleep for other platforms
  #endif
  */
